    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-background px-4">
        <div className="text-center max-w-sm">
          ...
          <p className="text-muted-foreground text-sm mb-6">Welcome to SMART-ACADEMY. Your 7-day Pro trial has started.</p>
          <Link href="/dashboard"><Button className="gap-2 shadow-sm"><GraduationCap className="w-4 h-4" /> Go to Dashboard</Button></Link>
        </div>
      </div>
    );
  }
      ...
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          ...
          <p className="mt-1 text-sm text-muted-foreground">
            Start with a free{" "}
            <Badge variant="outline" className="text-primary border-primary/30 text-xs">7-day Pro trial</Badge>
          </p>
        </div>
        ...
        <div className="rounded-xl border border-border/60 bg-card p-6 shadow-sm">
          ...
          <div className="grid grid-cols-2 gap-3">
            <Button variant="outline" size="sm" className="w-full text-xs" onClick={() => setSubmitted(true)}>
